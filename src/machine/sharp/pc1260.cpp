...
{								//[constructor]
    ...
    BackGroundFnameBackLight	= P_RES(":/pc1260/pc1260light.png");
...
bool Cpc1260::Chk_Adr(UINT32 *d,UINT32 data)
{
    ...
    if ( (*d>=0x2000) && (*d<=0x207D) )	{ pLCDC->SetDirtyBuf(*d-0x2000); pLCDC->updated=true; return(1); }	/* LCDC (0200x) */
    if ( (*d>=0x2800) && (*d<=0x287D) )	{ pLCDC->SetDirtyBuf(*d-0x2000); pLCDC->updated=true; return(1);	}	/* LCDC (0200x) */
...
{								//[constructor]
    ...
    BackGroundFnameBackLight	= P_RES(":/pc1261/pc1261light.png");
...
{								//[constructor]
    ...
    BackGroundFnameBackLight	= P_RES(":/pc1262/pc1262light.png");
